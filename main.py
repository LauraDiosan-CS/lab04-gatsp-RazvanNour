...
#inspirat din:
#https://www.youtube.com/watch?v=zumC_C0C25c&t=456s
...
def lab4(self):
    ...
    MUTATION_RATE = 0.1
    cost1, TARGET_CHROMOSOME = find_the_path(graph, POPULATION_SIZE, 0, -1)
    ...
    class GeneticAlgorithm:
        ...
        def _crossover_chromosomes(chromosome1, chromosome2):
            ...
            for i in range(1, TARGET_CHROMOSOME.__len__() - 1):
        ...
        def _mutate_chromosome(chromosome):
            for i in range(1, TARGET_CHROMOSOME.__len__() - 1):
                if random.random() < MUTATION_RATE:
                    ...
                    for k in range(1, TARGET_CHROMOSOME.__len__() - 1):
